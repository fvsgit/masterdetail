		...
		onTheMasterPage : {
			...
			actions : {
				...
				iSortTheListOnName : function () {
					return this.iChooseASorter("sortButton", "Sort By <EventType>");
				},
				...
				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<Index>", "<100 <EventType>");
				},
						...
						success : function (aEntityData) {
							this.waitFor({
								...
								success : function (oList) {
									...
									oCurrentItem.bindingPath = "/" + oList.getModel().createKey("Changes", {
										ObjectId : sCurrentId
									});
				...
				iRememberTheListItem : function (oListItem) {
					...
					this.getContext().currentItem = {
						...
						title: oBindingContext.getProperty("EventType")
					};
				}
			},
			...
			assertions : {
				...
				theListHeaderDisplaysZeroHits : function () {
					return this.waitFor({
						...
						id: "masterPageTitle",
						autoWait: false,
						matchers: new PropertyStrictEquals({name : "text", value : "<Changes> (0)"}),
						success: function () {
				...
				theListShouldBeSortedAscendingOnName : function () {
					return this.theListShouldBeSortedAscendingOnField("EventType");
				},
				...
				theListShouldHaveAllEntries : function () {
					...
					// retrieve all Changes to be able to check for the total amount
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							this.waitFor({
								id : "masterPageTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name : "text", value : "<Changes> (" + iExpectedLength + ")"}),
								success : function () {
